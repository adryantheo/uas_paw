...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_Register__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_Login__ = __webpack_require__(16);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_Jobs__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_Jobs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__components_Jobs__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_AboutUs__ = __webpack_require__(21);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_Testimoni__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_Testimoni___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8__components_Testimoni__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_TambahJobs_vue__ = __webpack_require__(25);
...
var router = new __WEBPACK_IMPORTED_MODULE_1_vue_router__["a" /* default */]({
    ...
    routes: [{
        ...
        path: '/jobs',
        name: 'jobs',
        component: __WEBPACK_IMPORTED_MODULE_6__components_Jobs___default.a,
        children: []
    }, {
        path: '/testimoni',
        name: 'testimoni',
        component: __WEBPACK_IMPORTED_MODULE_8__components_Testimoni___default.a
    }, {
        path: '/aboutus',
        name: 'aboutus',
...
Component.options.__file = "resources/js/components/Jobs.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-44673841", Component.options)
  } else {
    hotAPI.reload("data-v-44673841", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        btnTambah: function btnTambah() {
            this.$router.push({ name: 'tambahjobs' });
        }
    }
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-19b32af0", Component.options)
  } else {
    hotAPI.reload("data-v-19b32af0", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
  ...
  function() {
    ...
    return _c("div", { staticClass: "container" }, [
      _c("div", { staticClass: "row justify-content-center" }, [
        _c("div", { staticClass: "col-md-8" }, [
          _c("div", { staticClass: "card card-default" }, [
            _c("div", { staticClass: "card-header" }, [_vm._v("About Us")]),
            _vm._v(" "),
            _c("div", { staticClass: "card-body" }, [
              _c("h2", [_vm._v("TENTANG KAMI")]),
              _vm._v(" "),
              _c("p", [
                _vm._v(
                  "Misi kami adalah menyelamatkan para pejuang yang tanpa lelah menuntut ilmu dengan cara menawarkan jasa agar kesejahteraan mereka terjamin tidak hanya dengan bantuan belas kasihan para pejuang sebelumnya namun juga oleh jerih payah, darah dan keringat mereka sendiri pula."
                )
              ]),
              _vm._v(" "),
              _c("p", [_vm._v("Berikut Sedikit info Mengenai Anggota Kami")])
            ])
          ]),
          _vm._v(" "),
          _c("br"),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-19b32af0", module.exports)
  }
}
...
Component.options.__file = "resources/js/components/Testimoni.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-cac514ce", Component.options)
  } else {
    hotAPI.reload("data-v-cac514ce", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
                ...
                return _c(
                  ...
                  [
                    _c("tr", [
                      ...
                      _vm._v(" "),
                      _c("td", { attrs: { width: "40%" } }, [
                        _vm._v(_vm._s(data.namaT))
                      ]),
                      _vm._v(" "),
                      _c("td", { attrs: { width: "50%" } }, [
                        _vm._v(" " + _vm._s(data.pesan) + " ")
                      ])
                    ])
                  ]
                )
                  ...
                  _c("div", { staticClass: "form-group row" }, [
                    ...
                    _c("div", { staticClass: "col-md-6" }, [
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.data.namaT,
                            expression: "data.namaT"
                          }
                        ],
                        staticClass: "form-control",
                        attrs: {
                        ...
                        domProps: { value: _vm.data.namaT },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                            }
                            _vm.$set(_vm.data, "namaT", $event.target.value)
                          }
                        }
                      })
                    ])
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.data.pesan,
                            expression: "data.pesan"
                          }
                        ],
                        staticClass: "form-control",
                        attrs: { required: "" },
                        domProps: { value: _vm.data.pesan },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                            }
                            _vm.$set(_vm.data, "pesan", $event.target.value)
                          }
                        }
                      })
                    ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-cac514ce", module.exports)
  }
}
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        addmessege: function addmessege() {
            var _this = this;

            var uri = "/api/testimoni/";
            axios.post(uri, this.data).then(function (response) {
                _this.load = false;
            });
        },
        getData: function getData() {
            ...
            axios.get('/api/testimoni').then(function (response) {
